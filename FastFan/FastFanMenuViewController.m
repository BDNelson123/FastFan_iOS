...
@interface FastFanMenuViewController ()

@property (strong,nonatomic) NSArray *menu;

@end

@implementation FastFanMenuViewController
...
- (void)viewDidLoad
{
    ...
    self.menu = [NSArray arrayWithObjects:@"Profile", @"FanFeed", nil];
